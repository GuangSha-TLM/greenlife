package com.gsxy.greenlife.controller;

import com.alibaba.fastjson2.JSONArray;
import com.gsxy.greenlife.domain.User;
import com.gsxy.greenlife.domain.bo.UserLoginBo;
import com.gsxy.greenlife.domain.vo.ResponseVo;
import com.gsxy.greenlife.service.UserService;
...
public class UserController {
    ...
    public String queryById(@PathVariable("id") Long id) {
         ...
         return JSONArray.toJSONString(new ResponseVo("查询成功",this.userService.queryById(id),"0x200"));
